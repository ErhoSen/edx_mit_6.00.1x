...
class edx(object):
	...
	if course == "6.00x":
	    self.myCourses[0].setGrade(grade)
	elif course == "6.01x":
	    self.myCourses[1].setGrade(grade)
	elif course == "6.02x":
	    self.myCourses[2].setGrade(grade)
	...
	if course == "6.00x":
	    return self.myCourses[0].getGrade()
	elif course == "6.01x":
	    return self.myCourses[1].getGrade()
	elif course == "6.02x":
	    return self.myCourses[2].getGrade()
	else:
	    return -1
	...
	if course == "6.00x":
	    return self.myCourses[0].setPset(pset, score)
	elif course == "6.01x":
	    return self.myCourses[1].setPset(pset, score)
	elif course == "6.02x":
	    return self.myCourses[2].setPset(pset, score)
	...
	if course == "6.00x":
	    return self.myCourses[0].getPset(pset)
	elif course == "6.01x":
	    return self.myCourses[1].getPset(pset)
	elif course == "6.02x":
	    return self.myCourses[2].getPset(pset)
	else:
	    return -1
